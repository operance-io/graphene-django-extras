...
class LimitOffsetGraphqlPagination(BaseDjangoGraphqlPagination):
    ...
    def __init__(
        ...
        # A numeric value indicating the limit to use if one is not provided
        # by the client in a query parameter.
        self.default_limit = default_limit

        # If set this is a numeric value indicating the maximum allowable limit
        ...
        # A string or tuple/list of strings that indicating the default ordering
        ...
        return {
            self.limit_query_param: Int(
                ...
                description=(
                    ...
                    f"and 'max_limit': {self.max_limit}"
                ),
            ),
...
class PageGraphqlPagination(BaseDjangoGraphqlPagination):
    ...
    def __init__(
        ...
        # A string or comma delimited string values that indicate the default ordering
        # when obtaining lists of objects.
        # Uses Django order_by syntax
        self.ordering_param = ordering_param
        ...
        self.page_size_query_description = (
            ...
            f"Default 'page_size': {self.page_size}"
        )
    ...
    def to_graphql_fields(self):
        paginator_dict = {
            ...
            self.ordering_param: String(
                description=(
                    'A string or comma delimited string values that indicate '
                    'the default ordering when obtaining lists of objects.'
                )
            ),
        }
